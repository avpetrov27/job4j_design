...
class SimpleMapTest {
    ...
    @Test
    void whenCheckRemoveTest2() {
        assertThat(map.remove(10)).isFalse();
        assertThat(map).hasSize(4);
    }

    @Test
    void whenCheckIteratorTest1() {
        ...
        assertThat(it.next()).isEqualTo(29);
        assertThat(it.hasNext()).isFalse();
        assertThatThrownBy(it::next)
                .isInstanceOf(NoSuchElementException.class);
    }
    ...
    @Test
    void whenCheckIteratorTest2() {
        assertThat(map.put(32, "32")).isTrue();
        assertThat(map.put(6, "6")).isTrue();
        Iterator<Integer> it = map.iterator();
        assertThat(it.hasNext()).isTrue();
